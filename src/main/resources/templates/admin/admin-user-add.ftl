                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="post" action="${base}/admin/user/save">
...
<#--                                  </div>-->
                                      ...
                                      <div class="col-sm-10">
                                          <div class="radios">
                                              ...
                                              <label class="label_radio" for="radio-02">
                                                  <input name="role.roleName" id="radio-02" value="2" type="radio" checked /> 管理员
                                              </label>
                                          </div>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="phoneNum"  placeholder="请输入电话号码">
                                      </div>
                                  </div>
                                  <div class="form-group">
