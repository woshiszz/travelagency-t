          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="${base}/traveller/findAllTraveller">旅客资料</a></li>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body" >
                              <form class="form-horizontal tasi-form" method="post" action="${base}/traveller/updateTravellerById">
...
<#--                                  </div>-->
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-5">
                                          <input type="text" class="form-control" name="name"  value="${travellerInfo.name}" readonly>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">身份证号</label>
                                      <div class="col-sm-5">
                                          <input type="text" class="form-control" name="idCardNum" value="${travellerInfo.idCardNum}" readonly>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">用户名</label>
                                      <div class="col-sm-5">
                                          <input type="text" class="form-control" name="username" value="${travellerInfo.username}" readonly>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-5">
                                          <input type="tel" class="form-control" name="telephone"  value="${travellerInfo.telephone}" readonly>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">邮箱地址</label>
                                      <div class="col-sm-5">
                                          <input type="email" class="form-control" name="email"  value="${travellerInfo.email}" readonly>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      ...
                                      <div class="input-group date" id='datetimepicker1'>
                                          <input type="text" id="birthday" class="form-control" name="birthday"  value="${travellerInfo.birthday}" readonly>
