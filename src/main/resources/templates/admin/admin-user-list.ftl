...
<#--                          <div class="space15"></div>-->
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
                              ...
                              <tr class="">
                                  ...
                                  <td>${user.phoneNum}</td>
                                  <td style="color: <#if user.status='开启'>#2ECC71<#else >#E74C3C</#if>">${user.status}</td>

<!--                                  <td class="center">super user</td>-->
<#--                                  <td><a class="edit" href="${base}/admin/user/findById?id=${user.id}">编辑</a></td>-->
<#--                                  <td><a class="delete" href="javascript:;">删除</a></td>-->
                                  <td><a  href="${base}/admin/user/findById?id=${user.id}">编辑</a></td>
<#--                                  <td><a  href="javascript:;" onclick="return del()">删除</a></td>-->

                                  <td>
                                      <a  data-toggle="modal" href="#myModal${user_index+1}" type="delete">
                                          删除
                                      </a>
                                      <div class="modal fade" id="myModal${user_index+1}" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
                                          <div class="modal-dialog">
                                              <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                      ...
                                                      <button class="btn btn-success" type="button" onclick="location.href='${base}/admin/user/delete?id=${user.id}'">确定</button>
                                                  </div>
                                              </div>
                                          </div>
                                      </div>
