...
<#--                          <div class="space15"></div>-->
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
                              ...
                              <tbody>
                              <#list travellerList as traveller >
                              <tr class="">
                                  <td>${traveller_index+1}</td>
                                  <td>${traveller.name}</td>
                                  <td>${traveller.username}</td>
                                  <td>${traveller.sex}</td>
                                  <td>${traveller.telephone}</td>
                                  <td>${traveller.email}</td>
                                  <td style="color: <#if traveller.statusStr='开启'>#2ECC71<#else >#E74C3C</#if>">${traveller.statusStr}</td>
...
<#--                                  <td><a class="delete" href="javascript:;">删除</a></td>-->
                                  <td><a  href="${base}/traveller/findTravellerById?uid=${traveller.uid}">详情</a></td>
<#--                                  <td><a  href="javascript:;" onclick="return del()">删除</a></td>-->

                                  <td>
                                      <a  data-toggle="modal" href="#myModal${traveller_index+1}" type="delete">
                                          删除
                                      </a>
                                      <div class="modal fade" id="myModal${traveller_index+1}" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
                                          <div class="modal-dialog">
                                              <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                      ...
                                                      <button class="btn btn-success" type="button" onclick="location.href='${base}/traveller/deleteTravellerById?uid=${traveller.uid}'">确定</button>
                                                  </div>
                                              </div>
                                          </div>
                                      </div>
